...
export ARO_HCP_VERSION=${ARO_HCP_VERSION:-v20260901preview}
...
if [ "$ARO_HCP_VERSION" == "v1api20251223preview" ] ; then
    ARO_TEMPLATE=${ARO_TEMPLATE:-'aro-template-v1api20251223preview.yaml'}
fi
